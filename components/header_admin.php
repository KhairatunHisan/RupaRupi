...
<nav class="navbar navbar-dark fixed-top shadow-sm px-3 py-3" style="background: linear-gradient(135deg, #1e3a5f 0%, #0a1929 100%);">
    <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <a href="../admin/dashboard.php" class="text-white text-decoration-none fs-4" title="Beranda">
        ...
        <a href="../admin/profile_admin.php" class="text-white text-decoration-none fs-4" title="Profil">
